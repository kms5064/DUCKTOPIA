class MovableObjectBase {
  ...
  move(deltaTime) {
    ...
    // [6] 현재 좌표 계산 및 적용
    this.x = this.x + this.speed * directX * deltaTime;
    this.y = this.y + this.speed * directY * deltaTime;
    ...
    return { direct: { x: directX, y: directY }, speed: this.speed, position, timestamp: Date.now() };
  }
}

export default MovableObjectBase;
