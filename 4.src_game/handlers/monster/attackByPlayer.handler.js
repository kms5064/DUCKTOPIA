...
//몬스터 공격 모션 동기화 작업
//몬스터의 동기화를
const AttackByPlayerHandler = async ({ socket, payload, userId }) => {
  ...
  const monsterAttackNotification = [config.packetType.S_MONSTER_ATTACK_NOTIFICATION, payload];
  game.notification(userId, monsterAttackNotification);
};
